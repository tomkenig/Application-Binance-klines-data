...
def get_filenames_to_download(interval_param_):
    if interval_param_ == "monthly_hist":
        ...
        date_length = 7
        hist_days = 1
    elif interval_param_ == "file_update":
        date_length = 10
        hist_days = 3
    else:
        date_length = 10
...
if __name__ == "__main__":
    ...
    # monthly files works
    download_settings_id, market, tick_interval, data_granulation, stock_type, stock_exchange, range_to_download, download_api_interval_sec, daily_update_from_files, monthly_update_from_files, start_hist_download_ux_timestamp = q.get_queue_settings("monthly_hist")
    ...
    # daily
    delete_old_files()
    download_settings_id, market, tick_interval, data_granulation, stock_type, stock_exchange, range_to_download, download_api_interval_sec, daily_update_from_files, monthly_update_from_files, start_hist_download_ux_timestamp = q.get_queue_settings("daily_hist")
